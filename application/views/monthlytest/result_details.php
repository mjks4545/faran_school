              ...
              <div class="panel-heading">Result Details
                ...
                <div class="panel-body">
                    ...
                    <div class="row" style="position: relative;margin-top: 25px;">
                            ...
                            <div class="row">
                                 <div class="form-group col-md-4 margin_left">
                                  <label>Guardian Contact:&nbsp;&nbsp; </label><?= $result->guardian_number?>
                                 </div>
                                 <div class="form-group col-md-4">
                            ...
                            <div class="row">
                                 ...
                                 <div class="form-group col-md-4">
                                  <label>Subject:&nbsp;&nbsp; </label></label><?= $result->category_title?>
                                 </div>
                            </div>
                            ...
                            <div class="panel-body">
                                    <table data-toggle="table" data-show-refresh="false" data-search="false" data-pagination="false">
                                        <thead>
                                        <tr>
                                            <th class="text-center" data-sortable="true"><b>Class</b></th>
                                            <th class="text-center" data-sortable="true"><b>Subject</b></th>
                                            <th class="text-center" data-sortable="true"><b>Month</b></th>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center"><?=$result->course_title?></td>
                                            <td class="text-center"><?=$result->category_title?></td>
                                            <td class="text-center"><?=$result->test_month?></td>

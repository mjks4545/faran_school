                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="post" action="<?= site_url()?>monthlytest/create_monthlytest_result_after_post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Class</label>
                                <select  name="class_name" id="coursename_dropdown" class="form-control" style="background:#444D53; color:white;">
				   ...
				   <?php foreach ($result as $course){ ?>
				    ...
				    <?php } ?>
                            ...
                            <div class="form-group col-md-6">
                                <label>Subject</label>
                                 <select  name="subject_name" id="subcategory_dropdown" class="form-control" style="background:#444D53; color:white;">

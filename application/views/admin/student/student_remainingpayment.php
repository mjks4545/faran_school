 <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Students / Remaining Pay</li>
        </ol>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-10 margin_left">
            <div class="panel panel-default">
                ...
                <a href="<?= site_url()?>admin/student_view" type="button" class="btn btn-primary btn-outline margin col-sm-1  pull-right"><b>Back</b></a>
                </div>
                <div class="panel-body">
                             <?php 
                              ...
                              ?>
                    <form role="form" method="post" action="<?= site_url()?>admin/remaining_balance/<?=$result->s_id?>"> 
                        <div class="row">
